...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xf38f2; //hdr
...
const uint64_t MINIMUM_FEE                                   = 369963;
...
const char     MINER_CONFIG_FILE_NAME[]                      = "cashier_conf.json";
} // parameters
...
const int      P2P_DEFAULT_PORT                              = 1020;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 1024;
